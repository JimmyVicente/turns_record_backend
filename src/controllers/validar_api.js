'use strict';
var mensaje_api = require('./mensaje_api');
...
exports.errorServer = async function (req, res, error, mensaje, tipo) {
    ...
    var json = {
        mensaje: mensaje ?? mensaje_api.mensaje_error_500,
        tipo: tipo ?? mensaje_api.tipo_error,
        mensaje_alterno: error ?? "",
        url: req.originalUrl,
        ip: req.ip,
    };
    if (mensaje_api.imprimir_logs) {
...
exports.succeesServer = async function (req, res, data, mensaje, mensaje_alterno) {
    var json = {
        mensaje: mensaje ?? mensaje_api.mensaje_success,
        tipo: mensaje_api.tipo_success,
        data: data ?? {},
